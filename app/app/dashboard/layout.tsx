      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-gray-700 mt-auto">
            <p className="text-xs text-gray-400">© {new Date().getFullYear()} HealthMate</p>
          </div>
        </div>
      </aside>
        ...
        <header className="bg-gray-900 text-white shadow-lg sticky top-0 z-30">
          <div className="px-4 py-3 flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h2 className="text-lg font-semibold bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
                Health Dashboard
              </h2>
            </div>
